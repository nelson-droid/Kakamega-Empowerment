      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-xl md:text-2xl italic mb-6" style={{ fontFamily: 'Playfair Display, serif' }}>
            "GreenRoots has transformed our community. We've gone from food insecurity to sustainability champions in just 18 months. Their approach combines education, technology and community involvement perfectly."
          </p>
          <div>
