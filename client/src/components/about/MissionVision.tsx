  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-20 mission-vision-container">
      <div className={isVisible ? 'opacity-100' : 'opacity-0'} style={{ transition: 'opacity 0.6s ease-out' }}>
        <img 
          src={missionImage} 
          alt="Kakamega Empowerment Mission" 
      ...
      <div className={`self-center ${isVisible ? 'opacity-100' : 'opacity-0'}`} style={{ transition: 'opacity 0.6s ease-out, transform 0.6s ease-out', transform: isVisible ? 'translateY(0)' : 'translateY(20px)' }}>
        ...
        <p className="text-gray-600 mb-6">  Kakamega Empowerment is dedicated to combating climate change by promoting sustainable urban farming practices in rural communities. We believe in empowering individuals with the knowledge, skills, and resources to create self-sufficient and environmentally friendly food systems.
        </p>
