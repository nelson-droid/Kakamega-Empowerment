    ...
    <div className="mb-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <HistoryItem 
          number="3" 
          title="Present Day" 
          description="Today, Kakamega Empowerment operates 25+ community gardens, employs innovative climate mitigation strategies, and partners with schools, local governments, and businesses."
        />
      </div>
    </div>
  );
